...
RUN apk --no-cache add curl binutils make gcc g++ --repository http://dl-cdn.alpinelinux.org/alpine/3.15/community/ vips-dev=8.12.2-r1
USER apprunner
...
USER root
RUN apk add --repository http://dl-cdn.alpinelinux.org/alpine/3.15/community/ vips-dev=8.12.2-r1
USER apprunner

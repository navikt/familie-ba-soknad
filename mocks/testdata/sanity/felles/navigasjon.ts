import { INavigasjonTekstinnhold } from '../../../../src/frontend/typer/sanity/tekstInnhold';
import { lagLocaleRecordString } from '../lagSanityObjekter';

export const navigasjonTekstinnhold: INavigasjonTekstinnhold = {
    ...
    sistLagret: lagLocaleRecordString(),
};

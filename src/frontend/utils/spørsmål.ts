...
import { PensjonSpørsmålId } from '../components/Felleskomponenter/PensjonModal/spørsmål';
...
export const samletSpørsmålSpråkTekstId: Record<
    Exclude<SpørsmålId, UtenlandsoppholdSpørsmålId | PensjonSpørsmålId>, // UtenlandsoppholdSpørsmålId har ikke statiske spørsmålstekster
    string
> = {
